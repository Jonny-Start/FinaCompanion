...
const billSchema = new Schema(
  {
    contact_id: { type: String, required: false, default: 0 }, //Id del contacto al que se le asigno el movimiento de cuenta, 0 a si mismo
    ...
    group_id: { type: String, required: false }, // Id del grupo al que pertenece o a la carpeta a al que pertenece
